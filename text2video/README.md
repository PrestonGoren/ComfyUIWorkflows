The simplest possible text-->video ComfyUI Workflow. This extends upon the [basictext2image](../text2image/README.md) workflow by passing the checkpoint model through the AnimateDiff Loader node.
